 ...
 *
 * <p>API surface verified against the exact Iceberg-1.18.2-fabric-1.0.38
 * jar: {@code RenderTooltipEvents.GATHER} is a Fabric {@code Event<Gather>},
 * {@code Gather.onGather} takes (ItemStack, int, int, List<Either<FormattedText,
 * TooltipComponent>>, int, int), and {@code GatherResult} has a public
...
public final class IcebergTooltipGatherCompat {
    ...
    public static void registerIfPresent() {
        ...
        try {
            ...
            // gatherEvent.getClass() fails with IllegalAccessException under
            // Java 17. Invoke the public interface API instead.
    ...
    private static Component asComponent(FormattedText text) {
        ...
        return plain == null ? com.yourname.simpletranslate.core.LegacyComponentFactory.empty() : com.yourname.simpletranslate.core.LegacyComponentFactory.literal(plain);
    }
