...
public final class ComponentSegmentHelper {
    ...
    public static String getDirectText(Component component) {
        ...
        Component safeComponent = ComponentRenderSafety.sanitize(component);
        ...
        for (Component sibling : safeComponent.getSiblings()) {
    ...
    private static void extractSegments(Component component, List<TextSegmentInfo> segments, Style parentStyle,
    ...
    private static void collectTranslatableArgSegments(TranslatableComponent translatable, Style parentStyle,
     ...
     */
    private static void supplementTranslatableArgs(TranslatableComponent translatable, Component component,
        ...
        for (Object arg : args) {
            if (arg instanceof Component argComponent) {
                Component safeArg = ComponentRenderSafety.sanitize(argComponent);
