...
public class SignTranslationScreen extends ScrollableSettingsScreen {
    ...
    public SignTranslationScreen(Screen parent) {
        super(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.sign_translation"), parent);
    ...
    protected void buildContent() {
        addSectionHeader(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.sign.section").getString());

        CycleButton<Boolean> signButton = CycleButton.onOffBuilder(signEnabled)
                .create(0, 0, contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.sign.enabled"),
                        (button, value) -> signEnabled = value);
        withTooltip(signButton, "screen.simple_translate.sign.enabled.tooltip");
        addEntry(signButton);

        CycleButton<ModConfig.SignContextMode> contextModeButton = CycleButton.<ModConfig.SignContextMode>builder(mode -> com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.sign.context_mode." + mode.name().toLowerCase())).withInitialValue(signContextMode)
                .withValues(ModConfig.SignContextMode.values())
                .create(0, 0, contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.sign.context_mode"),
        ...
        CycleButton<Integer> radiusButton = CycleButton.<Integer>builder(value -> com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.radius.blocks", value)).withInitialValue(signRadius)
                .withValues(IntStream.rangeClosed(1, 32).boxed().toList())
                .create(0, 0, contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.sign.radius"),
                        (button, value) -> signRadius = value);
        withTooltip(radiusButton, "screen.simple_translate.sign.radius.tooltip");
        addEntry(radiusButton);

        addSectionHeader(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.sign.manual_hint").getString());
    }
