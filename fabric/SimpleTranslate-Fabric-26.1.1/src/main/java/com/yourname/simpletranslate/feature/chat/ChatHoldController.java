    ...
    void restoreTranslatedMessages() {
        ...
        for (int i = 0; i < allMessages.size(); i++) {
            ...
            if (originalPeer != null) {
                allMessages.set(i, new GuiMessage(msg.addedTime(), originalPeer, msg.signature(), msg.source(), msg.tag()));
                changed = true;
                continue;
            }
            ...
            allMessages.set(i, new GuiMessage(
                    msg.addedTime(), data.originalMessage(), msg.signature(), msg.source(), msg.tag()));
            changed = true;
        }
        ...
        for (int i = 0; i < allMessages.size(); i++) {
            ...
            if (originalPeer != null) {
                ...
                holdSwappedTranslated.add(new HeldSwap(
                        new ChatMessageIdentity(originalPeer, originalPeer.getString(), msg.signature(), msg.tag(),
            ...
            if (messageId != null) {
                ...
                if (data != null && data.state() == ButtonMessageData.State.TRANSLATED) {
                    ...
                    allMessages.set(i, new GuiMessage(msg.addedTime(), originalWithButton, msg.signature(), msg.source(), msg.tag()));
                    holdSwappedTranslated.add(new HeldSwap(
                            new ChatMessageIdentity(originalWithButton, originalWithButton.getString(), msg.signature(),
