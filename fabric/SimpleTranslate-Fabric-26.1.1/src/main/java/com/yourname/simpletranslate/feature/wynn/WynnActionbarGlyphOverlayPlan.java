 ...
 * {@link GuiGraphicsExtractor} is deferred, so a render-wide flag would be
...
public final class WynnActionbarGlyphOverlayPlan {
    ...
    public static final class Plan {
        ...
        public boolean render(GuiGraphicsExtractor graphics, Font font,
            ...
            graphics.text(font, maskedSourceSequence, x, y, color, true);
            for (PositionedSlot slot : layout.slots()) {
                ScreenAnchor anchor = slot.source().screenAnchor();
                ...
                try {
                    ...
                    graphics.text(font, slot.component(), 0, 0, color, true);
                } finally {
