...
public class TokenMonitorScreen extends ScrollableSettingsScreen {
    ...
    private static final class InfoCardWidget extends AbstractWidget {
        ...
        protected void extractWidgetRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
            ...
            graphics.text(font, trim(font, heading.getString(), textWidth), textLeft, top + 7, 0xFFFFFFFF, false);
            int y = top + 22;
            for (String line : lines) {
                ...
                graphics.text(font, trim(font, line, textWidth), textLeft, y, 0xFFD6D9DE, false);
                y += 11;
            }
        }
