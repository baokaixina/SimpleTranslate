...
public final class TooltipTranslationGlowRenderer {
    ...
    public static void render(GuiGraphics graphics, Screen screen, Font font,
        ...
        for (ClientTooltipComponent component : components) {
            ...
            // 1.19.4 ClientTooltipComponent#getHeight takes no font argument.
        ...
        // 1.19.4 ClientTooltipPositioner#positionTooltip takes the Screen.
        Vector2ic position = positioner.positionTooltip(screen, mouseX, mouseY, width, height);
