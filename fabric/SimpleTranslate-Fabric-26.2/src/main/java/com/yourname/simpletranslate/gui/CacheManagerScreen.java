...
public class CacheManagerScreen extends BaseSimpleTranslateScreen {
    ...
    private void editSelectedEntry() {
        ...
        if (selected != null) {
            ClientGuiCompat.setScreen(Minecraft.getInstance(), new CacheEditScreen(this, selected.key));
        }
    }
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.text(this.font, Component.translatable("screen.simple_translate.cache.stats",
                count,
        ...
        // Draw column headers
        graphics.text(this.font, Component.translatable("screen.simple_translate.cache.header.lane"),
                rowLeft + 8, LIST_TOP - 10, 0xFFAAAAAA);
        graphics.text(this.font, Component.translatable("screen.simple_translate.cache.header.key"),
                rowLeft + 82, LIST_TOP - 10, 0xFFAAAAAA);
        graphics.text(this.font, Component.translatable("screen.simple_translate.cache.header.translation"),
    ...
    private class CacheEntry extends ObjectSelectionList.Entry<CacheEntry> {
        ...
        public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY,
            ...
            graphics.text(CacheManagerScreen.this.font, displayLane, left + 5, top + 5, 0xFF88CCFF);
            ...
            graphics.text(CacheManagerScreen.this.font, displayKey, left + 78, top + 5, 0xFFFFFFFF);
            ...
            graphics.text(CacheManagerScreen.this.font, displayTranslation, left + 240, top + 5, 0xFF88FF88);
        }
