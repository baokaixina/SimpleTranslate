...
Assert-PathMissing "$src/mixin/TextDisplayMixin.java" "Display entity is 1.19.4+ only; text display mixin must not ship on 1.19.3"
Assert-FileNotContains "$res/simple_translate.mixins.json" "TextDisplayMixin" "text display mixin must not be registered on 1.19.3"
