...
public class ModelSettingsScreen extends ScrollableSettingsScreen {
    ...
    protected void buildContent() {
        ...
        this.formatButton = CycleButton.<ApiFormat>builder(
                        format -> Component.literal(format.getDisplayName()),
                        this.currentApiFormat)
        ...
        this.maxParallelButton = CycleButton.<Integer>builder(
                        value -> Component.literal(String.valueOf(value)),
                        this.currentMaxParallelRequests)
