...
public final class TranslationProfileScreen extends BaseSimpleTranslateScreen {
    ...
    private LegacyMultiLineEditBox descriptionInput;
    private Component status = com.yourname.simpletranslate.core.LegacyComponentFactory.empty();

    public TranslationProfileScreen(Screen parent) {
        super(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.translation_profile"));
        this.parent = parent;
    }
    ...
    protected void init() {
        ...
        this.descriptionInput = new LegacyMultiLineEditBox(this.font, left, INPUT_TOP, panelWidth, inputHeight,
                com.yourname.simpletranslate.core.LegacyComponentFactory.empty(),
                com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.translation_profile.context"));
        ...
        Button saveButton = ButtonCompat.builder(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.save"),
                        button -> saveProfile())
        ...
        Button resetButton = ButtonCompat.builder(
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.translation_profile.reset"),
                        button -> resetProfile())
        ...
        Button backButton = ButtonCompat.builder(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.back"),
                        button -> onClose())
    ...
    private void saveProfile() {
        ...
        this.status = com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.translation_profile.saved");
    }
    ...
    private void resetProfile() {
        ...
        this.status = com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.translation_profile.reset_done");
    }
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.drawCenteredString(this.font,
                com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.translation_profile.description"),
        ...
        if (this.descriptionInput != null && this.descriptionInput.getValue().isBlank()) {
            graphics.drawString(this.font,
                    com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.translation_profile.context.hint"),
    ...
    private static Component scopeLabel() {
        ...
        if (server != null) {
            ...
            return com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.translation_profile.scope.server", name);
        }
        if (minecraft.getSingleplayerServer() != null) {
            return com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.translation_profile.scope.world",
                    minecraft.getSingleplayerServer().getWorldData().getLevelName());
        }
        return com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.translation_profile.scope.global");
    }
