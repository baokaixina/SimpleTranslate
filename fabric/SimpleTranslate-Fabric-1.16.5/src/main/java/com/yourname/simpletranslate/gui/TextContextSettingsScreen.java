...
public final class TextContextSettingsScreen extends ScrollableSettingsScreen {
    ...
    public TextContextSettingsScreen(Screen parent) {
        super(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.text_context"), parent);
    ...
    protected void buildContent() {
        addSectionHeader(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.text_context.privacy").getString());
        addDescription(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.text_context.privacy_notice").getString());
        ...
        addSectionHeader(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.text_context.presets").getString());
        Button allPreset = ButtonCompat.builder(
                com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.text_context.preset.all"), button -> {
        ...
        addEntry(allPreset);
        Button uiPreset = ButtonCompat.builder(
                com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.text_context.preset.ui"), button -> {
        ...
        addEntry(uiPreset);
        Button clearPreset = ButtonCompat.builder(
                com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.text_context.preset.clear"), button -> {
        ...
        addSectionHeader(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.text_context.sources").getString());
    ...
    private void addToggle(String key, boolean initial, java.util.function.Consumer<Boolean> setter) {
        CycleButton<Boolean> button = CycleButton.onOffBuilder(initial)
                .create(0, 0, contentWidth, 20, com.yourname.simpletranslate.core.LegacyComponentFactory.translatable(key),
                        (ignored, value) -> {
                            setter.accept(value);
                            status = com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.text_context.saved");
                        });
    ...
    private void applyPreset(boolean value, boolean excludeChat, String statusKey) {
        ...
        saveSettings();
        ModConfig.save();
        status = com.yourname.simpletranslate.core.LegacyComponentFactory.translatable(statusKey);
    ...
    protected void renderAboveScrollableContentBeforeBottomActions(GuiGraphics graphics,
        ...
        if (status != null && !status.getString().isBlank()) {
            graphics.drawCenteredString(this.font, status, this.width / 2, 29, 0xFF88FF88);
        }
    }
}
