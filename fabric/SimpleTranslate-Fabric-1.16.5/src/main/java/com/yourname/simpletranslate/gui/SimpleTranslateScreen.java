...
public class SimpleTranslateScreen extends BaseSimpleTranslateScreen {
    ...
    private static Component shortcutHint(net.minecraft.ChatFormatting formatting,
        ...
        MutableComponent hint = com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.shortcuts.hint_prefix")
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        Component statusText = com.yourname.simpletranslate.core.LegacyComponentFactory.translatable(ready
        ...
        if (recentError != null) {
            Component error = com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.status.api_error");
    ...
    private final class SectionHeaderWidget extends AbstractWidget {
        ...
        public void renderButton(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
            ...
            Component arrow = com.yourname.simpletranslate.core.LegacyComponentFactory.literal(isExpanded(this.section) ? "\u25be " : "\u25b8 ");
