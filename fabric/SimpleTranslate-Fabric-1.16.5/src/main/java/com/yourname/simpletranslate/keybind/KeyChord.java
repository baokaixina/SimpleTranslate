...
public record KeyChord(InputType type, int code, int modifiers) {
    ...
    public boolean isPrimaryDown(Minecraft minecraft) {
        ...
        return type == InputType.MOUSE
                ...
                : InputConstants.isKeyDown(minecraft.getWindow().getWindow(), code);
    }
    ...
    public Component displayName() {
        if (!isBound()) {
            return com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.shortcuts.none").withStyle(ChatFormatting.GRAY);
        }
        MutableComponent result = com.yourname.simpletranslate.core.LegacyComponentFactory.empty();
