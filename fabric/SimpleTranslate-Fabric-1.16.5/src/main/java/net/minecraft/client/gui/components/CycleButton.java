...
public class CycleButton<T> extends Button {
    ...
    private CycleButton(int x, int y, int width, int height, Component narration,
                        Function<T, Component> valueLabel, List<T> values, T initial,
    ...
    public static <T> Builder<T> builder(Function<T, Component> valueLabel) {
    ...
    public static Builder<Boolean> onOffBuilder(boolean initial) {
        return new Builder<Boolean>(value -> value
                ? new net.minecraft.network.chat.TranslatableComponent("gui.yes")
                : new net.minecraft.network.chat.TranslatableComponent("gui.no"))
    ...
    public static final class Builder<T> {
        ...
        private Builder(Function<T, Component> valueLabel) {
            this.valueLabel = valueLabel;
        }
        ...
        public CycleButton<T> create(int x, int y, int width, int height, Component narration,
                                     OnValueChange<T> onValueChange) {
