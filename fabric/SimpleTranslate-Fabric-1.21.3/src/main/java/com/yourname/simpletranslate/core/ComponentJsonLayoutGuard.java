 ...
 *
 * <p>Keeps absolute-positioned PUA streams (resource-pack HUD actionbars, multi-font
 * HUD packs) from being remounted onto {@code minecraft:default} after
...
public final class ComponentJsonLayoutGuard {
    ...
    public static boolean shouldKeepLayoutCriticalHudOriginal(String surface, String sourceJson,
        ...
        try {
            return isLayoutCriticalHudTree(JsonParser.parseString(sourceJson));
        } catch (Exception e) {
            return false;
        }
    }
    ...
    public static boolean satisfiesInPlaceLayoutContract(String translationJson, String sourceJson) {
        ...
        JsonElement source;
        try {
            source = JsonParser.parseString(sourceJson);
        } catch (Exception e) {
        ...
        try {
            JsonElement translation = JsonParser.parseString(translationJson);
    ...
    public static boolean isLayoutBrokenCustomFontTranslation(String translationJson, String sourceJson) {
        ...
        try {
            JsonElement sourceRoot = JsonParser.parseString(sourceJson);
            JsonElement translationRoot = JsonParser.parseString(translationJson);
    ...
    private static boolean matchesComponentExceptText(JsonElement source, JsonElement translation) {
        ...
        Set<String> sourceKeys = new java.util.HashSet<>(sourceObject.keySet());
        Set<String> translationKeys = new java.util.HashSet<>(translationObject.keySet());
