...
public enum ShortcutAction {
    ...
    TRANSLATE_GUI("screen.simple_translate.shortcuts.action.translate_gui", KeyChord.keyboard(GLFW.GLFW_KEY_K)),
    TRANSLATE_TOOLTIP("screen.simple_translate.shortcuts.action.translate_tooltip", KeyChord.keyboard(GLFW.GLFW_KEY_V)),
    SIGN_SELECT("screen.simple_translate.shortcuts.action.sign_select", KeyChord.keyboard(GLFW.GLFW_KEY_G)),
    SIGN_SUBMIT("screen.simple_translate.shortcuts.action.sign_submit", KeyChord.keyboard(GLFW.GLFW_KEY_H));
