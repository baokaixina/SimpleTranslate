...
public final class DirectStatusTerms {
    ...
    /** Plain "source -> target" glossary lines for the minimal wire protocol. */
    ...
    public static String glossarySection(String source) {
        if (source == null || source.isBlank()) {
            return "";
        }
        ...
        StringBuilder builder = new StringBuilder("<st-glossary>");
        for (Entry entry : matching) {
            builder.append("<term source=\"")
                    .append(escape(entry.source()))
                    .append("\" target=\"")
                    .append(escape(entry.target()))
                    .append("\"/>");
        }
        builder.append("</st-glossary>");
        return builder.toString();
    }
