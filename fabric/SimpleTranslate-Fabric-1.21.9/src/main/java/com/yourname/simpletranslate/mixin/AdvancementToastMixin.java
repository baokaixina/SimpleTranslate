...
public class AdvancementToastMixin {
    ...
    @WrapMethod(
            method = "render(Lnet/minecraft/client/gui/GuiGraphics;Lnet/minecraft/client/gui/Font;J)V",
            require = 1)
    private void simple_translate$renderAdvancementToastFrame(
            GuiGraphics graphics, Font font, long visibleTime, Operation<Void> original) {
