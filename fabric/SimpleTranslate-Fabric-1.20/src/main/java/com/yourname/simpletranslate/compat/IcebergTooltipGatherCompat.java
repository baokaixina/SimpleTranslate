 ...
 *
 * <p>API surface verified against the Iceberg 1.20.1-fabric-1.1.18 (newest
 * build declaring Minecraft 1.20 support) and Legendary Tooltips
 * 1.20.1-fabric-1.4.5 jars, both installable on Minecraft 1.20. The actual
 * translation runs
