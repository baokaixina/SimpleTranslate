...
public final class SignContextSelectionManager {
    ...
    public static void submitSelection() {
        ...
        List<String> submittedKeys = new ArrayList<>();
        ...
        for (Selection selection : orderedSelections) {
            ...
            submittedKeys.add(selection.key);
        ...
        SignTranslationHelper.requestManualContextTranslation(contexts, success ->
                Minecraft.getInstance().execute(() -> finishSubmittedSelection(submittedKeys, success)));
    }
    ...
    private static void finishSubmittedSelection(List<String> submittedKeys, boolean success) {
    ...
    private static void showCountMessage(String key) {
        ...
        if (minecraft.player != null) {
            minecraft.player.displayClientMessage(Component.translatable(key, SELECTIONS.size()), true);
        }
    }
