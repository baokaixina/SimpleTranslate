...
public final class TranslationProfileScreen extends BaseSimpleTranslateScreen {
    ...
    protected void init() {
        ...
        this.descriptionInput = new MultiLineEditBox(this.font, left, INPUT_TOP, panelWidth, inputHeight,
                Component.empty(),
        ...
        Button saveButton = ButtonCompat.builder(Component.translatable("screen.simple_translate.save"),
                        button -> saveProfile())
        ...
        Button backButton = ButtonCompat.builder(Component.translatable("screen.simple_translate.back"),
                        button -> onClose())
