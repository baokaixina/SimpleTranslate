...
public class SimpleTranslateScreen extends BaseSimpleTranslateScreen {
    ...
    protected void init() {
        ...
        this.backButton = ButtonCompat.builder(Component.translatable("screen.simple_translate.back"), button -> onClose())
    ...
    private int addPageButton(int y, int width, String labelKey, String tooltipKey, ScreenFactory factory) {
        Button button = ButtonCompat.builder(Component.translatable(labelKey),
