 ...
 *
 * <p>API surface verified against the installed Iceberg-1.19.1-fabric-1.0.46
 * jar (the only Fabric build declared for 1.19.2, minecraft ~1.19): {@code RenderTooltipEvents.GATHER} is a Fabric {@code Event<Gather>},
