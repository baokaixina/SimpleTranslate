...
public class OcrTranslationScreen extends ScrollableSettingsScreen {
    ...
    protected void buildContent() {
        ...
        this.historyButton = UiCompat.buttonBuilder(
        ...
        UiCompat.setHint(this.apiUrlInput, Component.translatable("screen.simple_translate.ocr.api_url_hint"));
        ...
        UiCompat.setHint(this.apiKeyInput, Component.translatable("screen.simple_translate.ocr.api_key_hint"));
        ...
        UiCompat.setHint(this.modelInput, Component.translatable("screen.simple_translate.ocr.model_hint"));
        ...
        this.checkButton = UiCompat.buttonBuilder(checkLabel, button -> checkOcrApi())
                .bounds(0, 0, this.contentWidth, 20)
                .build();
    ...
    private EditBox numericInput(String labelKey, String hintKey, int value) {
        ...
        UiCompat.setHint(input, Component.translatable(hintKey));
