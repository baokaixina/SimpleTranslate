 ...
 *
 * <p>API surface verified against the Iceberg 1.21.1-fabric-1.3.2 jar (the
 * newest 1.21.x series loadable on Minecraft 1.21.8): the event class moved to
 ...
 * not a Fabric Event. The actual translation runs through
