...
public class AdvancementToastMixin {
    ...
    @WrapMethod(
            method = "render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/gui/components/toasts/ToastComponent;J)Lnet/minecraft/client/gui/components/toasts/Toast$Visibility;",
            require = 1)
    private Toast.Visibility simple_translate$renderAdvancementToastFrame(
            PoseStack poseStack, ToastComponent toast, long visibleTime, Operation<Toast.Visibility> original) {
