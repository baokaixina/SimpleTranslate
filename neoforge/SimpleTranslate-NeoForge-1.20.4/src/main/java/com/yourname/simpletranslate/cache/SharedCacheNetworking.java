...
/**
 * NeoForge 20.4 transport for the shared-cache channel. Registration goes
 * through RegisterPayloadHandlerEvent on the mod bus; the wire format and
 * semantics are the donor's (see {@link SharedCachePayload}).
 */
