...
Write-Host "SimpleTranslate 1.20.5 logic checks (product sync from 1.21.3 donor, Wynn stripped for <1.21.4)"
...
# NeoForge 1.20.5: no Iceberg artifact exists for Minecraft 1.20.5 on any loader
...
Write-Host "1.20.5 logic checks PASSED"
