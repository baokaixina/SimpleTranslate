...
Write-Host "SimpleTranslate 1.21.11 logic checks (product sync from 26.1.1)"
...
Assert-FileContains "$src/mixin/TitleOverlayMixin.java" '"renderOverlayMessage(Lnet/minecraft/client/gui/GuiGraphics;Lnet/minecraft/client/DeltaTracker;)V"' "Wynn dialogue/actionbar isolation must use the exact vanilla render owner"
...
Assert-FileContains "$src/mixin/compat/WynntilsOverlayManagerMixin.java" 'renderOverlays(Lcom/wynntils/mc/event/RenderEvent;Lcom/wynntils/core/consumers/overlays/RenderState;)V' "exact Wynntils all-overlay target required"
...
Write-Host "1.21.11 logic checks PASSED"
