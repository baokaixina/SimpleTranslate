...
Write-Host "SimpleTranslate Forge 1.20.1 logic checks (product sync from fabric 1.20.1 donor)"
...
# Forge 1.20.1 runtime replaces vanilla Gui.render with ForgeGui.render
# (verified against forge-1.20.1-47.4.10 bytecode, 2026-07-26): Gui.render
...
Assert-FileNotContains "$src/mixin/TitleOverlayMixin.java" '"render(Lnet/minecraft/client/gui/GuiGraphics;F)V"' "dead Gui.render hooks must not return (ForgeGui.render never calls them)"
...
Write-Host "Forge 1.20.1 logic checks PASSED"
