 ...
 *
 * <p>Iceberg publishes no build for Minecraft 1.21.10 on any loader (the
 * Modrinth listing jumps from 1.21.4 straight to 1.21.11, checked 2026-07),
 * so this reflective integration stays dormant until a future port appears.
 * The expected API shape is verified against the Iceberg
 * 1.21.11-neoforge-1.4.0.1 jar: the event class lives at
 ...
 * not a loader event. The actual translation runs through
