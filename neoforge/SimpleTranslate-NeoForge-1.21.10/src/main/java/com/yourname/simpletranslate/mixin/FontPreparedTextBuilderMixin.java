 ...
 * {@link TextRenderable} as "nothing to draw". Consequently the
...
public abstract class FontPreparedTextBuilderMixin {
    @WrapOperation(
            ...
            at = @At(
                    value = "INVOKE",
                    target = "Lnet/minecraft/client/gui/font/glyphs/BakedGlyph;createGlyph(FFIILnet/minecraft/network/chat/Style;FF)Lnet/minecraft/client/gui/font/TextRenderable;"
            ),
            require = 1
    )
    private TextRenderable simple_translate$maskCurrentWynnGlyph(
            BakedGlyph glyph,
            float x,
            float y,
            int textColor,
            ...
            float boldOffset,
            float shadowOffset,
            Operation<TextRenderable> original) {
