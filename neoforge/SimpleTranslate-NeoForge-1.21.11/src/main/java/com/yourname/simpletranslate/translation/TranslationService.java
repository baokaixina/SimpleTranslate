...
public interface TranslationService {
    ...
    /**
     * Translate a reversible formatted component document. The model must keep the
     * document tags/attributes intact and translate only visible run text.
     */
    CompletableFuture<String> translateFormattedDocument(String document, String sourceLanguage,
