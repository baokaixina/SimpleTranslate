...
public class ChatTranslationScreen extends ScrollableSettingsScreen {
    ...
    protected void buildContent() {
        ...
        this.modeButton = CycleButton.<ModConfig.TranslationMode>builder(
                ...
                .create(0, 0, contentWidth, 20,
                        ...
                        (button, value) -> currentMode = value);
    ...
    private void updateButtonStates() {
        ...
        if (this.contextEnabledToggle != null) {
            this.contextEnabledToggle.active = this.contextEnabledToggle.visible && chatEnabled;
        }
        if (this.contextCountButton != null) {
            this.contextCountButton.active = this.contextCountButton.visible && chatEnabled && contextEnabled;
        }
    }
    ...
    protected void saveSettings() {
        ...
        ModConfig.CHAT_CONTEXT_ENABLED.set(contextEnabled);
