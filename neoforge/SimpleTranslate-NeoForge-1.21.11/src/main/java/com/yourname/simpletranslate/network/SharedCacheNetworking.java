...
public final class SharedCacheNetworking {
    ...
    public static void register(IEventBus modEventBus) {
        ...
        modEventBus.addListener(SharedCacheNetworking::registerClientPayloads);
    }
    ...
    private static void registerClientPayloads(RegisterClientPayloadHandlersEvent event) {
        event.register(SharedCachePayload.TYPE,
                (payload, context) -> context.enqueueWork(() -> SharedCacheClient.handlePayload(payload)));
    }
