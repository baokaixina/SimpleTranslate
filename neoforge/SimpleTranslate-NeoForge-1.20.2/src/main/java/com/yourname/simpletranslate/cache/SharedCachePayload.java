...
// NeoForge 20.2 loader adaptation: 20.2 has no payload/registrar networking
// stack, so this stays a plain message class registered on a SimpleChannel;
// wire semantics stay identical to the Fabric donor.
