...
public class GuiTranslationScreen extends ScrollableSettingsScreen {
    ...
    public GuiTranslationScreen(Screen parent) {
        ...
        this.ftbQuestsInstalled = net.neoforged.fml.ModList.get().isLoaded("ftbquests")
                || net.neoforged.fml.ModList.get().isLoaded("ftb-quests");
        this.tipsInstalled = net.neoforged.fml.ModList.get().isLoaded("tipsmod");
    }
