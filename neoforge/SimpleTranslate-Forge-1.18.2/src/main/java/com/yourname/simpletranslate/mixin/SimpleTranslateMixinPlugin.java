...
public class SimpleTranslateMixinPlugin implements IMixinConfigPlugin {
    ...
    public void onLoad(String mixinPackage) {
        // Forge 40.x has no JarJar delivery for MixinExtras. Shade only the
        // common runtime and initialize it before any @WrapOperation or
        // @WrapMethod mixin is prepared. Shading the Forge adapter instead
        // registers an undeclared second mod (mixinextras) and aborts boot.
