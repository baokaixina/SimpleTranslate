...
public final class ModKeyBindings {
     ...
     *
     * <p>1.19.2 KeyMapping categories are plain translation-key strings; the
    ...
    private static boolean hasFocusedTextInput(Minecraft minecraft) {
        ...
        return focused instanceof EditBox || focused instanceof com.yourname.simpletranslate.gui.LegacyMultiLineEditBox;
    }
    ...
    private static void toggleTranslationMode() {
        ...
        Minecraft minecraft = Minecraft.getInstance();
        if (minecraft.player != null) {
            Component mode = com.yourname.simpletranslate.core.LegacyComponentFactory.translatable(next == ModConfig.TranslationMode.AUTO
