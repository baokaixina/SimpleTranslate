 ...
 * {@code Iceberg-1.18.2-forge-1.0.49.jar} (the exact Forge artifact inspected
 * for this target): the Forge Iceberg build has no
 ...
 * forge-1.18.2-40.2.21-universal.jar) exposes {@code getTooltipElements()},
