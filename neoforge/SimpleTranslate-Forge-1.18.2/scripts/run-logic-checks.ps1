...
Write-Host "SimpleTranslate Forge 1.18.2 logic checks (product sync from fabric 1.18.2 donor)"
...
# Forge 1.19.2 ships Mixin 0.8.5 whose @Inject has no `order` member (0.8.6+);
...
Write-Host "Forge 1.18.2 logic checks PASSED"
