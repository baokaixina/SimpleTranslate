...
Assert-FileContains "$src/mixin/TitleOverlayMixin.java" 'Mixin 0.8.5 (NeoForge 47.1.x) has no Inject#order' "documented NeoForge injector-order adaptation must stay"
