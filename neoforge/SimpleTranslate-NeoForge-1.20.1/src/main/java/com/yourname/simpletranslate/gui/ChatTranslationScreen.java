...
public class ChatTranslationScreen extends ScrollableSettingsScreen {
    ...
    protected void buildContent() {
        ...
        this.batchIntervalInput.setHint(Component.translatable("screen.simple_translate.chat.context_time_hint"));
        ...
        this.collectWindowInput.setHint(Component.translatable("screen.simple_translate.chat.context_time_hint"));
