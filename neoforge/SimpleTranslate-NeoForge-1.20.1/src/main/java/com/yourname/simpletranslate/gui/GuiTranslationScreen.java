...
public class GuiTranslationScreen extends ScrollableSettingsScreen {
    ...
    public GuiTranslationScreen(Screen parent) {
        ...
        this.ftbQuestsInstalled = net.minecraftforge.fml.ModList.get().isLoaded("ftbquests")
                || net.minecraftforge.fml.ModList.get().isLoaded("ftb-quests");
        this.tipsInstalled = net.minecraftforge.fml.ModList.get().isLoaded("tipsmod");
    }
