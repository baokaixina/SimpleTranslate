...
public final class TranslationPromptPolicy {
    ...
    public static String runtimeFingerprint() {
        ...
        for (String surface : new String[]{
                ...
                "book", "sign.auto", "hud.actionbar", "hud.actionbar.wynn.dialogue.content.semantic_fragments.v1",
                "scoreboard", "entity.name", "text_display.component"}) {
    ...
    public static String normalizedRole(String role) {
        ...
        return value.isBlank() ? "game-text" : value;
    }
