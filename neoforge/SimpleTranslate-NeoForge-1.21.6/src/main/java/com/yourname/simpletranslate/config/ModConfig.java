...
public class ModConfig {
     ...
     * selectors use their dedicated source-anchored semantic renderer.
     */
    ...
    public static final BooleanValue HUD_WYNN_OVERLAY_ENABLED = bool("hud.wynnOverlayEnabled", true);
