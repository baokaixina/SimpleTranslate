...
public class TermManagerScreen extends BaseSimpleTranslateScreen {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Draw column headers
        graphics.text(this.font, Component.translatable("screen.simple_translate.terms.term"), this.width / 2 - 150, 30, 0xFFAAAAAA);
        graphics.text(this.font, Component.translatable("screen.simple_translate.cache.edit.translation"), this.width / 2 + 20, 30, 0xFFAAAAAA);
    ...
    private class TermEntry extends ObjectSelectionList.Entry<TermEntry> {
        ...
        public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY,
            ...
            // Draw term
            graphics.text(TermManagerScreen.this.font,
                    term.length() > 20 ? term.substring(0, 17) + "..." : term,
                    centerX - 150, top + 5, 0xFFFFFFFF);

            // Draw arrow
            graphics.text(TermManagerScreen.this.font, "->", centerX, top + 5, 0xFF888888);
