...
public abstract class AdvancementWidgetMixin {
    ...
    @WrapMethod(method = "extractHover(Lnet/minecraft/client/gui/GuiGraphicsExtractor;IIFII)V", require = 1)
    private void simple_translate$drawAdvancementFrame(
            GuiGraphicsExtractor graphics, int x, int y, float fade, int width, int height,
