...
public final class BookBookmarkControl {
     ...
     */
    public static void renderEdgeTab(GuiGraphics graphics, Font font, int screenWidth, int screenHeight,
     ...
     */
    private static void draw(GuiGraphics graphics, Font font, int x, int y, int screenWidth,
    ...
    private static void drawControl(GuiGraphics graphics, Font font, int x, int y, int screenWidth,
                                    int mouseX, int mouseY, boolean hovered,
                                    boolean active, boolean translating) {
