...
public class CacheManagerScreen extends BaseSimpleTranslateScreen {
    ...
    private class CacheEntry extends ObjectSelectionList.Entry<CacheEntry> {
        ...
        public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY,
            ...
            graphics.text(CacheManagerScreen.this.font, displayLane, left + 5, top + 3, 0xFF88CCFF);
            ...
            graphics.text(CacheManagerScreen.this.font, displayKey, left + 78, top + 3, 0xFFFFFFFF);
            ...
            graphics.text(CacheManagerScreen.this.font, displayTranslation, left + 240, top + 3, 0xFF88FF88);
        }
