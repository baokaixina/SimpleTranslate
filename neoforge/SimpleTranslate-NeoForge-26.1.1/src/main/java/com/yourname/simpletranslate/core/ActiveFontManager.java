...
public final class ActiveFontManager {
    public static final Identifier CJK_FALLBACK_FONT =
            Identifier.fromNamespaceAndPath("simple_translate", "cjk");
    ...
    public static FontSet getCjkFallbackFontSet() {
        ...
        return ((FontManagerAccessor) manager).simple_translate$getFontSetRaw(CJK_FALLBACK_FONT);
    }
}
