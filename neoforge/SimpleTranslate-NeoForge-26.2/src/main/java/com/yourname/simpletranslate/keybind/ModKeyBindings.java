...
public final class ModKeyBindings {
    ...
    private static void onClientTick(ClientTickEvent.Post event) {
        ...
        boolean editingModSettings = minecraft.gui.screen() instanceof BaseSimpleTranslateScreen;
    ...
    private static void dispatch(ShortcutAction action, Minecraft minecraft) {
        switch (action) {
            ...
            case SIGN_SELECT -> {
                if (minecraft.gui.screen() == null) SignContextSelectionManager.toggleDragSelectionMode();
            }
            case SIGN_SUBMIT -> {
                if (minecraft.gui.screen() == null) SignContextSelectionManager.submitSelection();
            }
        }
    }
    ...
    public static boolean handleTranslateGuiKey(KeyEvent event) {
        ...
        if (minecraft.gui.screen() instanceof BaseSimpleTranslateScreen || hasFocusedTextInput(minecraft)
    ...
    private static void requestCurrentGuiOrHudTranslation(Minecraft minecraft) {
        ...
        } else if (!(minecraft.gui.screen() instanceof BaseSimpleTranslateScreen)) {
    ...
    private static boolean hasFocusedTextInput(Minecraft minecraft) {
        if (minecraft == null || minecraft.gui.screen() == null) return false;
        Object focused = minecraft.gui.screen().getFocused();
    ...
    private static void openSettingsScreenSafely(Minecraft minecraft) {
        try {
            minecraft.gui.setScreen(new SimpleTranslateScreen(minecraft.gui.screen()));
        } catch (Throwable t) {
