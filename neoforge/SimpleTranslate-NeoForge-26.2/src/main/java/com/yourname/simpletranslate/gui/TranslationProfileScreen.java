...
public final class TranslationProfileScreen extends BaseSimpleTranslateScreen {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.centeredText(this.font, scopeLabel(), this.width / 2, 34, 0xFFAAAAAA);
        ...
        if (this.status != null && !this.status.getString().isBlank()) {
            graphics.centeredText(this.font, this.status, this.width / 2, this.height - 42, 0xFF88FF88);
        }
    }
