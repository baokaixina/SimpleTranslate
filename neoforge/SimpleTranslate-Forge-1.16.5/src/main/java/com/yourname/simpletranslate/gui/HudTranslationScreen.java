...
public class HudTranslationScreen extends ScrollableSettingsScreen {
    ...
    private TextFieldWidget batchIntervalInput;
    private TextFieldWidget collectWindowInput;

    public HudTranslationScreen(Screen parent) {
        super(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.hud_translation"), parent);
    ...
    protected void buildContent() {
        addSectionHeader(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.hud.section").getString());

        CycleButton<Boolean> scoreboardButton = CycleButton.onOffBuilder(scoreboardEnabled)
                .create(0, 0, contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.hud.scoreboard"),
        ...
        CycleButton<Boolean> bossbarButton = CycleButton.onOffBuilder(bossbarEnabled)
                .create(0, 0, contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.hud.bossbar"),
        ...
        CycleButton<Boolean> titleButton = CycleButton.onOffBuilder(titleEnabled)
                .create(0, 0, contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.hud.title"),
        ...
        CycleButton<Boolean> actionbarButton = CycleButton.onOffBuilder(actionbarEnabled)
                .create(0, 0, contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.hud.actionbar"),
        ...
        CycleButton<Boolean> layoutProtectionButton = CycleButton.onOffBuilder(keepLayoutCriticalOriginal)
                .create(0, 0, contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.settings.layout_critical_hud_keep_original"),
        ...
        CycleButton<Boolean> titleContextButton = CycleButton.onOffBuilder(titleContextEnabled)
                .create(0, 0, contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.hud.title_context"),
        ...
        CycleButton<Boolean> historyChatButton = CycleButton.onOffBuilder(historyChatEnabled)
                .create(0, 0, contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.hud.history_chat"),
        ...
        this.batchIntervalInput = new TextFieldWidget(this.font, 0, 0, contentWidth, 20,
                com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.hud.caption_batch_interval"));
        this.batchIntervalInput.setMaxLength(5);
        this.batchIntervalInput.setValue(Integer.toString(this.batchIntervalMs));
        this.batchIntervalInput.setSuggestion(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.hud.caption_time_hint").getString());
        ...
        this.collectWindowInput = new TextFieldWidget(this.font, 0, 0, contentWidth, 20,
                com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.hud.caption_collect_window"));
        this.collectWindowInput.setMaxLength(5);
        this.collectWindowInput.setValue(Integer.toString(this.collectWindowMs));
        this.collectWindowInput.setSuggestion(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.hud.caption_time_hint").getString());
    ...
    private static int parseMillis(TextFieldWidget input, int fallback) {
