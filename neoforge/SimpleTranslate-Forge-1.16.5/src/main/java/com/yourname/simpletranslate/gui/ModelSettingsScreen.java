...
public class ModelSettingsScreen extends ScrollableSettingsScreen {
    ...
    public ModelSettingsScreen(Screen parent) {
        super(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.model_settings"), parent);
    ...
    protected void buildContent() {
        ...
        this.apiUrlInput = new TextFieldWidget(this.font, 0, 0, this.contentWidth, 20,
                com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.model_settings.api_url"));
        this.apiUrlInput.setMaxLength(512);
        this.apiUrlInput.setValue(this.currentApiUrl);
        this.apiUrlInput.setSuggestion(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.model_settings.api_url_hint").getString());
        withTooltip(this.apiUrlInput, "screen.simple_translate.model_settings.api_url.tooltip");
        addEntry(this.apiUrlInput);

        this.apiKeyInput = new TextFieldWidget(this.font, 0, 0, this.contentWidth, 20,
                com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.model_settings.api_key"));
        this.apiKeyInput.setMaxLength(512);
        this.apiKeyInput.setValue(this.currentApiKey);
        this.apiKeyInput.setSuggestion(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.model_settings.api_key_hint").getString());
        ...
        this.apiKeyInput.setFormatter((value, pos) -> value.isEmpty()
                ...
                : IReorderingProcessor.forward("*".repeat(value.length()), Style.EMPTY));
        addEntry(this.apiKeyInput);

        this.modelInput = new TextFieldWidget(this.font, 0, 0, this.contentWidth, 20,
                com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.model_settings.model_id"));
        this.modelInput.setMaxLength(256);
        this.modelInput.setValue(this.currentModelId);
        this.modelInput.setSuggestion(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.model_settings.model_hint").getString());
        withTooltip(this.modelInput, "screen.simple_translate.model_settings.model_id.tooltip");
        addEntry(this.modelInput);

        this.formatButton = CycleButton.<ApiFormat>builder(format -> com.yourname.simpletranslate.core.LegacyComponentFactory.literal(format.getDisplayName())).withInitialValue(this.currentApiFormat)
                .withValues(ApiFormat.values())
                .create(0, 0, this.contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.model_settings.api_format"),
                        (button, value) -> {
        ...
        this.thinkingButton = CycleButton.onOffBuilder(this.currentThinkingEnabled)
                .create(0, 0, this.contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.thinking"),
                        (button, value) -> {
        ...
        this.maxParallelButton = CycleButton.<Integer>builder(value -> com.yourname.simpletranslate.core.LegacyComponentFactory.literal(String.valueOf(value))).withInitialValue(this.currentMaxParallelRequests)
                .withValues(1, 2, 3, 4, 5, 6, 7, 8)
                .create(0, 0, this.contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.model_settings.max_parallel"),
        ...
        ITextComponent checkLabel = this.checking
                ? com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.model_settings.checking")
                : (this.status.isBlank()
                        ? com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.model_settings.check")
                        : com.yourname.simpletranslate.core.LegacyComponentFactory.literal(shortText(this.status)));
        ...
        withTooltip(this.checkButton, this.status.isBlank()
                ? com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.model_settings.check.tooltip")
                : com.yourname.simpletranslate.core.LegacyComponentFactory.literal(this.status));
    ...
    private String text(String key, Object... args) {
        return com.yourname.simpletranslate.core.LegacyComponentFactory.translatable(key, args).getString();
    }
