...
public class TooltipGlowSettingsScreen extends ScrollableSettingsScreen {
    public TooltipGlowSettingsScreen(Screen parent) {
        super(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.tooltip_glow.feature"), parent);
        this.contentWidth = 300;
    }

    @Override
    protected void buildContent() {
        addSectionHeader(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.tooltip_glow.section").getString());

        CycleButton<Boolean> enabled = CycleButton.onOffBuilder(ModConfig.TOOLTIP_GLOW_ENABLED.get())
                .create(0, 0, this.contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.tooltip_glow.enabled"),
                        (button, value) -> {
        ...
        CycleButton<ModConfig.TooltipGlowTheme> theme = CycleButton
                .<ModConfig.TooltipGlowTheme>builder(value -> com.yourname.simpletranslate.core.LegacyComponentFactory.translatable(
                ...
                .create(0, 0, this.contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.tooltip_glow.theme"),
                        (button, value) -> {
    ...
    private final class GlowPreviewWidget extends Widget {
        private GlowPreviewWidget() {
            super(0, 0, TooltipGlowSettingsScreen.this.contentWidth, 76,
                    com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.tooltip_glow.preview"));
        }
        ...
        public void renderButton(MatrixStack poseStack, int mouseX, int mouseY, float partialTick) {
            ...
            int left = x + 10;
            int top = y + 9;
            int right = x + getWidth() - 10;
            int bottom = y + getHeight() - 9;
            ...
            graphics.drawString(TooltipGlowSettingsScreen.this.font,
                    com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.tooltip_glow.preview.title"),
                    left + 8, top + 8, 0x72D9D0);
            graphics.drawString(TooltipGlowSettingsScreen.this.font,
                    com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.tooltip_glow.preview.pending"),
                    left + 8, top + 24, 0xE0E0E0);
            graphics.drawString(TooltipGlowSettingsScreen.this.font,
                    com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.tooltip_glow.preview.hint"),
    ...
    private final class IntSliderWidget extends AbstractSlider {
        ...
        private IntSliderWidget(ModConfig.IntValue config, int min, int max, int step,
            ...
            super(0, 0, TooltipGlowSettingsScreen.this.contentWidth, 20, com.yourname.simpletranslate.core.LegacyComponentFactory.empty(),
