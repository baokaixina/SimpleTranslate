...
public class CacheManagerScreen extends BaseSimpleTranslateScreen {
    ...
    private ITextComponent statusMessage = com.yourname.simpletranslate.core.LegacyComponentFactory.empty();
    private int statusColor = 0xFFAAAAAA;

    public CacheManagerScreen(Screen parent) {
        super(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache_manager"));
        this.parent = parent;
    }
    ...
    protected void init() {
        ...
        this.serverShareButton = ButtonCompat.builder(
                serverShareLabel(),
        ...
        this.searchInput = new TextFieldWidget(this.font,
                rowLeft + shareWidth + 8,
                28,
                searchWidth,
                20,
                com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.search"));
        this.searchInput.setMaxLength(120);
        this.searchInput.setSuggestion(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.search_hint").getString());
        ...
        CycleButton<Boolean> cacheEnabledButton = CycleButton.onOffBuilder(
                ...
                .create(rowLeft, 88, 150, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.enabled"),
        ...
        this.editButton = ButtonCompat.builder(
                com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.edit"),
    ...
    private void refreshImportSourceStatus() {
        ...
        if (sources.isEmpty()) {
            setStatus(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.import.choose_folder"), 0xFFAAAAAA);
        } else {
            setStatus(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.import.available", sources.size()), 0xFF88CCFF);
        }
    }

    private void setStatus(ITextComponent message, int color) {
        this.statusMessage = message == null ? com.yourname.simpletranslate.core.LegacyComponentFactory.empty() : message;
        this.statusColor = color;
    }

    private ITextComponent serverShareLabel() {
        return com.yourname.simpletranslate.core.LegacyComponentFactory.translatable(SimpleTranslateMod.isCacheServerShareEnabled()
                ? "screen.simple_translate.cache.server_share.on"
                : "screen.simple_translate.cache.server_share.off");
    }

    private ITextComponent serverShareStatus() {
        if (!SimpleTranslateMod.isCacheServerShareEnabled()) {
            return com.yourname.simpletranslate.core.LegacyComponentFactory.empty();
        }
        if (!SharedCacheClient.isServerSupported()) {
            return com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.server_share.status.unsupported");
        }
        return com.yourname.simpletranslate.core.LegacyComponentFactory.translatable(
    ...
    private void toggleServerShare() {
        ...
        setStatus(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable(enabled
        ...
        if (cache != null) {
            try {
                ...
                TranslationCache.CacheShareExportResult result = cache.exportShareArchive(
                        ...
                        metadata,
                        null);
                setStatus(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.export.done",
                        result.entries(), result.lanes(), fileName), 0xFF88FF88);
            } catch (Exception e) {
                SimpleTranslateMod.getLogger().error("Failed to export cache", e);
                setStatus(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.export.failed"), 0xFF7777);
            }
        }
    }
        ...
        if (cache != null) {
            try {
                ...
                if (selectedSource == null) {
                    setStatus(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.import.cancelled"), 0xFFAAAAAA);
                    return;
                }
                ...
                if (result.imported() == 0
                    ...
                    setStatus(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.import.none"), 0xFFCC66);
                    return;
                }
                if (result.imported() == 0 && result.skippedWorldMismatch() > 0) {
                    setStatus(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.import.world_mismatch"), 0xFFCC66);
                    return;
                }
                setStatus(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.import.done",
                        result.imported(),
                ...
                setStatus(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.import.failed"), 0xFF7777);
            }
        }
    }
    ...
    private Path chooseImportSource() {
        String selectedFile = TinyFileDialogs.tinyfd_openFileDialog(
                com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.import.dialog").getString(),
                configDir().toString(),
                null,
    ...
    private Path configDir() {
        return FMLPaths.CONFIGDIR.get().resolve(SimpleTranslateMod.MODID);
    }
    ...
    public void render(MatrixStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.drawString(this.font, com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.stats",
                count,
                this.cacheList == null ? 0 : this.cacheList.children().size(),
                categoryCount), rowLeft, 54, 0xFFAAAAAA);
        ITextComponent shareStatus = serverShareStatus();
        int statusY = 66;
        if (!shareStatus.getString().isBlank()) {
            graphics.drawString(this.font,
                    com.yourname.simpletranslate.core.LegacyComponentFactory.literal(fitText(shareStatus.getString(), Math.max(80, rowRight - rowLeft - 8))),
        ...
        if (this.statusMessage != null && !this.statusMessage.getString().isBlank()) {
            graphics.drawString(this.font,
                    com.yourname.simpletranslate.core.LegacyComponentFactory.literal(fitText(this.statusMessage.getString(), Math.max(80, rowRight - rowLeft - 8))),
                    rowLeft, statusY, statusColor);
        }

        // Draw column headers
        graphics.drawString(this.font, com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.header.lane"),
                rowLeft + 8, LIST_TOP - 10, 0xFFAAAAAA);
        graphics.drawString(this.font, com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.header.key"),
                rowLeft + 82, LIST_TOP - 10, 0xFFAAAAAA);
        graphics.drawString(this.font, com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.header.translation"),
        ...
        if (this.cacheList != null && this.cacheList.children().isEmpty()) {
            graphics.drawCenteredString(this.font,
                    com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.no_matches"),
     ...
     */
    private class CacheList extends ExtendedList<CacheEntry> {
        private final int rowWidth;

        public CacheList(Minecraft minecraft, int screenWidth, int rowWidth, int top, int bottomY) {
            super(minecraft, screenWidth, Math.max(1, bottomY - top), top, bottomY, ROW_HEIGHT);
     ...
     */
    private class CacheEntry extends ExtendedList.AbstractListEntry<CacheEntry> {
        ...
        public void render(MatrixStack poseStack, int index, int top, int left, int width, int height,
            ...
            if (editedByPlayer) {
                displayTranslation = com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.entry_edited").getString()
                        + " " + displayTranslation;
            }
        ...
        public ITextComponent getNarration() {
            return com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.cache.entry_narration", lane, key, translation);
        }
    }
}
