...
public final class BookBookmarkControl {
     ...
     */
public static void render(GuiGraphics graphics, FontRenderer font, int screenWidth, int mouseX, int mouseY,
    ...
    private static void drawControl(GuiGraphics graphics, FontRenderer font, int screenWidth, int mouseX, int mouseY,
                              boolean active, boolean translating) {
        ...
        if (hovered) {
            renderInternalTooltip(graphics, font,
                    com.yourname.simpletranslate.core.LegacyComponentFactory.translatable(active
    ...
    private static void renderInternalTooltip(GuiGraphics graphics, FontRenderer font, ITextComponent label, int screenWidth,
