...
/** ITextComponent JSON chat translation runtime kept out of ChatComponentMixin. */
public final class ChatTranslationRuntime {
    ...
    public static ITextComponent buildCachedAutoMessageTranslation(ITextComponent message) {
        if (message == null) {
            return null;
        }
    ...
    public static CompletableFuture<ITextComponent> translateAutoMessage(ITextComponent message) {
        if (message == null) {
    ...
    public static CompletableFuture<ITextComponent> translateAutoMessageWithContext(ITextComponent message, String context) {
        if (message == null) {
            return CompletableFuture.completedFuture(null);
        }
    ...
    public static CompletableFuture<List<ITextComponent>> translateAutoMessagesWithContext(
            List<ITextComponent> messages, String context) {
    ...
    private static ITextComponent firstTranslated(ComponentListTranslationResult result, int expectedSize) {
        if (result == null || !result.translated || result.components == null
