...
/**
 * Translation facade. Every game-text request is wrapped as ITextComponent JSON.
 */
public final class TranslationManager {
    ...
    public CompletableFuture<String> translateRaw(
        ...
        return DirectSurfaceTranslator.translateComponentsAsync(
                        List.of(com.yourname.simpletranslate.core.LegacyComponentFactory.literal(source)), surface, role, false, "",
    ...
    public CompletableFuture<List<String>> translateRawBatch(
        ...
        return DirectSurfaceTranslator.translateComponentsAsync(
                        sources.stream().map(com.yourname.simpletranslate.core.LegacyComponentFactory::literal)
