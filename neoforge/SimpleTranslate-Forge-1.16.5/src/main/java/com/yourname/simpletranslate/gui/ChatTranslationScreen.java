...
public class ChatTranslationScreen extends ScrollableSettingsScreen {
    ...
    private TextFieldWidget outgoingChatCommandsInput;
    ...
    protected void buildContent() {
        ...
        this.outgoingChatCommandsInput = new TextFieldWidget(this.font, 0, 0, contentWidth, 20,
                com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.chat.outgoing_chat_commands"));
        ...
        this.outgoingChatCommandsInput.setSuggestion(
                com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.chat.outgoing_chat_commands.hint").getString());
