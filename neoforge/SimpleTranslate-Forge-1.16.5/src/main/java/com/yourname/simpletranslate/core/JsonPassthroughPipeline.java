...
public final class JsonPassthroughPipeline {
    ...
    private static DecodedProjectedResponse decodeProjectedResponse(
            String response, List<ITextComponent> originals, String sourceJson, @Nullable String surface,
            ComponentVisualProjection projection) {
    ...
    private static List<ITextComponent> deserializeComponents(
            String response, List<ITextComponent> originals, @Nullable String surface) {
        try {
            JsonElement root = new com.google.gson.JsonParser().parse(response.trim());
            if (!root.isJsonArray()) {
    ...
    static List<ITextComponent> finalizeTranslatedTree(
            JsonArray array, List<ITextComponent> originals, @Nullable String surface, String response) {
    ...
    private static void logDeserializationFailure(
            @Nullable String surface, String reason, List<ITextComponent> originals, int actual, String response) {
    ...
    private record DecodedProjectedResponse(String cacheTemplate, List<ITextComponent> components) {
    }

    static final record BatchItem(TranslationManager manager,
                             List<ITextComponent> originals,
                             String sourceJson,
                             String surface,
                             String role,
                             String context,
