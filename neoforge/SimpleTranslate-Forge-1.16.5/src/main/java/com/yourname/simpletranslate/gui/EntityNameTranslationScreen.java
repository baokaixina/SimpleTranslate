...
public class EntityNameTranslationScreen extends ScrollableSettingsScreen {
    ...
    public EntityNameTranslationScreen(Screen parent) {
        super(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.entity_translation"), parent);
    ...
    protected void buildContent() {
        addSectionHeader(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.entity.section").getString());

        CycleButton<Boolean> entityButton = CycleButton.onOffBuilder(entityNameEnabled)
                .create(0, 0, contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.entity.enabled"),
        ...
        CycleButton<Integer> radiusButton = CycleButton.<Integer>builder(value -> com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.radius.blocks", value)).withInitialValue(entityNameRadius)
                .withValues(4, 8, 12, 16, 20, 24, 32, 48, 64)
                .create(0, 0, contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.entity.radius"),
