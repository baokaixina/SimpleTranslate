...
import com.yourname.simpletranslate.vanillacompat.NarratableEntry;
...
public abstract class ScrollableSettingsScreen extends BaseSimpleTranslateScreen {
    ...
    public ScrollableSettingsScreen(ITextComponent title, Screen parent) {
        super(title);
        this.parent = parent;
    }
     ...
     */
    protected void addEntry(Widget widget, String label, int labelColor) {
    ...
    protected void repositionEntries() {
        ...
        for (SettingsEntry entry : entries) {
            if (entry.widget != null) {
                entry.widget.y = y;
                entry.widget.x = centerX - contentWidth / 2;
    ...
    protected static class SettingsEntry {
        ...
        public SettingsEntry(Widget widget, String label, int labelColor) {
            this.widget = widget;
            this.label = label;
