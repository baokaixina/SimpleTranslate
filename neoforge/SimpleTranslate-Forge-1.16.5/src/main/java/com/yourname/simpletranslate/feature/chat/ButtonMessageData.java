...
public class ButtonMessageData {
    ...
    private volatile ITextComponent translatedMessage;
    private volatile State state;

    public ButtonMessageData(ITextComponent originalMessage, String originalPlainText, long runtimeRevision) {
    ...
    public ITextComponent originalMessage() {
    ...
    public synchronized ITextComponent translatedMessage() {
        return translatedMessage;
    }

    public synchronized void setTranslatedMessage(ITextComponent translated) {
