...
public final class TooltipTranslationController {
    ...
    public static boolean shouldCaptureItemFrame(List<ITextComponent> components) {
    ...
    public static boolean shouldTranslateChatHover(ITextComponent hoverText) {
        if (!ModConfig.GLOBAL_ENABLED.get()) {
            return false;
        }
    ...
    public static void armPendingGlowForHover(ITextComponent component, boolean requestAllowed) {
    ...
    /** Shared by every semantic projection on every pending frame. */
    ...
    public static boolean allowRequest(RenderContext context, List<ITextComponent> components) {
