...
public class LanguageSettingsScreen extends ScrollableSettingsScreen {
    ...
    private TextFieldWidget sourceCustomInput;
    private TextFieldWidget targetCustomInput;

    public LanguageSettingsScreen(Screen parent) {
        super(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.language_settings"), parent);
    ...
    protected void buildContent() {
        ...
        CycleButton<String> sourceButton = CycleButton.<String>builder(this::languageLabel).withInitialValue(this.sourcePreset)
                ...
                .create(0, 0, this.contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.language_settings.source"),
                        (button, value) -> {
        ...
        this.sourceCustomInput = new TextFieldWidget(this.font, 0, 0, this.contentWidth, 20,
                com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.language_settings.source_custom"));
        this.sourceCustomInput.setMaxLength(48);
        this.sourceCustomInput.setValue(this.sourceCustom);
        this.sourceCustomInput.setSuggestion(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.language_settings.custom_hint").getString());
        ...
        CycleButton<String> targetButton = CycleButton.<String>builder(this::languageLabel).withInitialValue(this.targetPreset)
                ...
                .create(0, 0, this.contentWidth, 20,
                        com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.language_settings.target"),
                        (button, value) -> {
        ...
        this.targetCustomInput = new TextFieldWidget(this.font, 0, 0, this.contentWidth, 20,
                com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.language_settings.target_custom"));
        this.targetCustomInput.setMaxLength(48);
        this.targetCustomInput.setValue(this.targetCustom);
        this.targetCustomInput.setSuggestion(com.yourname.simpletranslate.core.LegacyComponentFactory.translatable("screen.simple_translate.language_settings.custom_hint").getString());
    ...
    private void refreshCustomInputs() {
        if (this.sourceCustomInput != null) {
            ...
            this.sourceCustomInput.visible = custom
                    && isEntryVisible(this.sourceCustomInput.y, this.sourceCustomInput.getHeight());
        ...
        if (this.targetCustomInput != null) {
            ...
            this.targetCustomInput.visible = custom
                    && isEntryVisible(this.targetCustomInput.y, this.targetCustomInput.getHeight());
    ...
    private String effectiveCode(String preset, TextFieldWidget customInput, String fallback) {
