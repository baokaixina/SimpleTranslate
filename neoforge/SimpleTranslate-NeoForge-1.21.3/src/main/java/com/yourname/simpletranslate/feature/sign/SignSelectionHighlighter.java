...
public final class SignSelectionHighlighter {
    ...
    public static void register() {
        ...
        registered = true;
        // NeoForge 21.2 predates the RenderLevelStageEvent.AfterEntities
        // convenience subclass; filter the unified stage event instead.
    ...
    private static void simple_translate$renderSelectionsImpl(RenderLevelStageEvent event) {
        ...
        if (minecraft == null || minecraft.level == null || event == null) {
            return;
        }
        ...
        for (SignContextSelectionManager.SelectionView selection :
            ...
            ShapeRenderer.renderLineBox(event.getPoseStack(), lines, box,
